# Content Designer (application period now closed)
...
The GSA Service Delivery team is hiring for a GS-15 permanent / career content designer. This is a remote position. 

Content designers are crucial to improving GSA products, platforms, and service. This is an opportunity to make a huge impact in the lives of public servants, GSA customers, GSA suppliers, and members of the public.  
...
- Consulting with teams to foster sustainable best practices for user-centered design and plain language
...
#### Key Objective 1: Demonstrate excellence in content best practices and advise on end-to-end product development
You are an experienced content designer who can help partners deliver clear, compelling, consistent, accurate, and accessible content and content strategy for digital products, platforms, and services. 

Successful content designers on the GSA Service delivery team:
- Research complex topics and synthesize findings and information into clear content that can be iteratively tested with end users
- Lead strategic content initiatives and deliver recommendations for developing user-centered content
- Plan, write, and edit content from concept to delivery to make digital products, platforms, or services simpler, clearer, and easier to use
- Create content for use across multiple channels, such as mobile, SMS, web, and print
- Adapt voice and writing style across a range of topics, audiences, and digital channels
- Present content strategy recommendations to partners
- Conduct content audits, when necessary, to organize, consolidate, or retire information 
- Determine information architecture and content structure at project level, such as mapsites, content models, content templates, libraries
- Use metrics and feedback to continually improve content
...
- Incorporate user-centered design and content best practices into agile development sprints, coordinating with experience designers, developers, product managers, and acquisition strategists to achieve a strategic vision
- Deliver what’s needed to guide development — this could include wireframes, sitemaps, flowcharts, storyboards, journey maps, prototypes, or user stories
- Use modern interaction design patterns and best practices
- Facilitate usability testing to make recommendations for improvements
...
While not required, experience with or more of the following would be useful:
...
As a content designer with the GSA Service Delivery team, a big part of the job is creating sustainable outcomes and benefits to GSA customers, suppliers, government employees, and the public. You’ll help ensure products, platforms, and services are sustained for long-term success. As part of that, you’ll share your expertise and experience with your teammates and GSA stakeholders to build user-centered design and content strategy best practices across the agency. 

Successful content designers on the GSA Service delivery team:
- Help partners understand the value of clear communication
...
- Improve the government’s design capacity by coaching and mentoring junior content designers
...
As a content designer with the GSA Service Delivery team, you’ll be working as part of a small, distributed, multidisciplinary agile team. You’ll participate in constructive discussions, openly share knowledge, and demonstrate value for your teammate’s contributions. 
